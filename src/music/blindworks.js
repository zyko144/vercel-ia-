...
const ANIME = [
  ...
  ['One Punch Man', 'opm|one punch', 'JAM Project', 'THE HERO !! ~Ikareru Kobushi ni Hi wo Tsukero~', 'tv:One Punch Man'],
  ['Mob Psycho 100', 'mob psycho', 'MOB CHOIR', '99', 'tv:Mob Psycho 100'],
  ['Haikyū', 'haikyuu|haikyu', 'SPYAIR', 'Imagination', 'tv:Haikyu!!'],
  ['Kuroko no Basket', 'kuroko|kuroko basket|kuroko no basuke', 'GRANRODEO', 'Can Do', "tv:Kuroko's Basketball"],
  ['Fairy Tail', '', 'FUNKIST', 'Snow Fairy', 'tv:Fairy Tail'],
  ['Seven Deadly Sins', 'nanatsu no taizai|seven deadly sins|7 deadly sins', 'Ikimonogakari', 'Netsujou no Spectrum', 'tv:The Seven Deadly Sins'],
  ['Black Clover', '', 'Vickeblanka', 'Black Rover', 'tv:Black Clover'],
  ['Dr. Stone', 'dr stone|doctor stone', 'BURNOUT SYNDROMES', 'Good Morning World!', 'tv:Dr. STONE'],
  ['Fire Force', 'enen no shouboutai', 'Mrs. GREEN APPLE', 'Inferno', 'tv:Fire Force'],
  ['Re:Zero', 'rezero|re zero', 'Konomi Suzuki', 'Redo', 'tv:Re:ZERO -Starting Life in Another World-'],
  ['Steins;Gate', 'steins gate|steinsgate', 'Kanako Itou', 'Hacking to the Gate', 'tv:Steins;Gate'],
  ['Code Geass', 'code geass lelouch', 'FLOW', 'COLORS', 'tv:Code Geass: Lelouch of the Rebellion'],
  ['Your Name', 'kimi no na wa|your name', 'RADWIMPS', 'Zenzenzense', 'wiki:Your Name'],
  ['Vinland Saga', '', 'Survive Said The Prophet', 'MUKANJYO', 'tv:Vinland Saga'],
  ['Tokyo Revengers', 'tokyo revenger', 'Official HIGE DANdism', 'Cry Baby', 'tv:Tokyo Revengers'],
  ['Kaguya-sama', 'kaguya sama|kaguya', 'Masayuki Suzuki', 'Love Dramatic', 'tv:Kaguya-sama: Love is War'],
  ['Konosuba', 'kono subarashii sekai ni shukufuku wo', 'Machico', 'fantastic dreamer', 'tv:Kono Subarashii Sekai ni Shukufuku wo!'],
  ['Overlord', '', 'OxT', 'Clattanoia', 'tv:Overlord'],
  ['Noragami', '', 'Hello Sleepwalkers', 'Goya no Machiawase', 'tv:Noragami'],
  ['Parasyte', 'kiseijuu|parasite', 'Fear, and Loathing in Las Vegas', 'Let Me Hear', 'tv:Kiseijuu: Sei no Kakuritsu'],
  ['Assassination Classroom', 'ansatsu kyoushitsu|assassination classroom', '3-nen E-gumi Utatan', 'Seishun Satsubatsu-ron', 'tv:Assassination Classroom'],
  ['Akame ga Kill', 'akame ga kiru', 'Sora Amamiya', 'Skyreach', 'tv:Akame ga Kill!'],
  ['Erased', 'boku dake ga inai machi', 'ASIAN KUNG-FU GENERATION', 'Re:Re:', 'tv:ERASED'],
  ['Angel Beats', 'angel beats', 'Lia', 'My Soul, Your Beats!', 'tv:Angel Beats!'],
  ['Anohana', 'ano hana', 'Galileo Galilei', 'Aoi Shiori', 'tv:Anohana: The Flower We Saw That Day'],
  ['Boruto', '', 'KANA-BOON', 'Baton Road', 'tv:Boruto: Naruto Next Generations'],
  ['Black Butler', 'kuroshitsuji|black butler', 'SID', 'Monochrome no Kiss', 'tv:Black Butler'],
  ['Soul Eater', '', "T.M.Revolution", 'Resonance', 'tv:Soul Eater'],
  ['Cowboy Bebop', '', 'Seatbelts', 'Tank!', 'tv:Cowboy Bebop'],
  ['Samurai Champloo', '', 'Nujabes', 'Battlecry', 'tv:Samurai Champloo'],
  ['Fate/Zero', 'fate zero|fate', 'LiSA', 'oath sign', 'tv:Fate/Zero'],
  ['JoJo', "jojo's bizarre adventure|jojo bizarre adventure|jjba", 'Coda', 'Bloody Stream', "tv:JoJo's Bizarre Adventure"],
  ['The Promised Neverland', 'promised neverland|yakusoku no neverland', 'UVERworld', 'Touch off', 'tv:The Promised Neverland'],
  ['Violet Evergarden', '', 'TRUE', 'Sincerely', 'tv:Violet Evergarden'],
  ['Your Lie in April', 'shigatsu wa kimi no uso|your lie in april', 'Goose house', 'Hikaru Nara', 'tv:Your Lie in April'],
  ['Food Wars', 'shokugeki no soma|food war', 'Ultra Tower', 'Kibou no Uta', 'tv:Food Wars! Shokugeki no Soma'],
  ['Détective Conan', 'detective conan|conan|case closed', 'THE HIGH-LOWS', 'Mune ga Doki Doki', 'tv:Case Closed'],
  ['Darling in the Franxx', 'darling in the franxx|franxx', 'Mika Nakashima', 'KISS OF DEATH', 'tv:DARLING in the FRANXX'],
  ['Mushoku Tensei', '', 'Yuiko Ohara', 'Tabibito no Uta', 'tv:Mushoku Tensei: Jobless Reincarnation'],
  ['Bungo Stray Dogs', 'bungou stray dogs', 'GRANRODEO', 'Trash Candy', 'tv:Bungo Stray Dogs'],
  ['Dororo', '', 'Queen Bee', 'Kaen', 'tv:Dororo'],
  ['Mashle', '', 'Taichi Mukai', 'Knock Out', 'tv:MASHLE: MAGIC AND MUSCLES'],
  ['Kaiju No. 8', 'kaiju no 8|kaiju 8', 'Yungblud', 'Abyss', 'tv:Kaiju No. 8'],
  ['Dandadan', 'dan da dan', 'Creepy Nuts', 'Otonoke', 'tv:DAN DA DAN'],
  ["Hell's Paradise", 'jigokuraku|hells paradise|hell paradise', 'millennium parade', 'Work', "tv:Hell's Paradise"],
  ['Bocchi the Rock', 'bocchi', 'Kessoku Band', 'Seishun Complex', 'tv:BOCCHI THE ROCK!'],
  ['Blue Exorcist', 'ao no exorcist', 'UVERworld', 'CORE PRIDE', 'tv:Blue Exorcist'],
  ['Sailor Moon', '', 'DALI', 'Moonlight Densetsu', 'tv:Sailor Moon'],
  ['Yu-Gi-Oh', 'yugioh|yu gi oh', 'Masami Okui', 'Overlap', 'tv:Yu-Gi-Oh!'],
  ['Gintama', '', 'Tommy heavenly6', 'Pray', 'tv:Gintama'],
];

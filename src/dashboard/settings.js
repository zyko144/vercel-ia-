...
export const SETTINGS = {
  ...
  voiceGuard: {
    ...
    help: 'Le bot écoute son salon vocal : une vraie insulte qui nomme « Noam » ou « Vercel » = avertissement, dès la 2e = exclusion d’1 min et sortie du vocal. Le chef n’est jamais écouté.',

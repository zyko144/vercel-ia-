...
contextBridge.exposeInMainWorld('launcher', {
  ...
  fivemJoin: (code) => ipcRenderer.invoke('fivem:join', code),
  chatThread: (fid) => ipcRenderer.invoke('chat:thread', fid),
  chatSend: (fid, text) => ipcRenderer.invoke('chat:send', fid, text),
  ...
  fivemServers: () => ipcRenderer.invoke('fivem:servers'),
  fivemFav: (code, on) => ipcRenderer.invoke('fivem:fav', code, Boolean(on)),
  gameHistory: (id) => ipcRenderer.invoke('stats:game', id),
  onUpdate: (fn) => ipcRenderer.on('update:state', (_e, u) => fn(u)),
  updateInfo: () => ipcRenderer.invoke('update:get'),

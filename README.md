...
- **Paroles en direct** (`/lyrics` ou le bouton 🎤) : la ligne chantée est surlignée et suit la musique, comme sur Spotify. Le changement de ligne est calé sur l'horodatage exact de la parole (avance de 0,35 s pour compenser le temps d'affichage de Discord). Si le son n'a pas de paroles synchronisées, il affiche les paroles normales.
